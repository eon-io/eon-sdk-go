...
// checks if the AccessConditionalExpression type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessConditionalExpression{}

// AccessConditionalExpression Conditional expression to evaluate to determine which resources are accessible.  Only one of the expressions below can be used. For multiple conditions using `AND` or `OR` logic, group expressions with `group`. You can nest multiple groups to create more complex expressions. 
type AccessConditionalExpression struct {
	Group NullableRoleAccessGroupCondition `json:"group,omitempty"`
...
func NewAccessConditionalExpression() *AccessConditionalExpression {
	this := AccessConditionalExpression{}
	return &this
}
...
func (o *AccessConditionalExpression) GetGroup() RoleAccessGroupCondition {
	if o == nil || IsNil(o.Group.Get()) {
		var ret RoleAccessGroupCondition
		return ret
	}
	return *o.Group.Get()
}
...
// SetGroup gets a reference to the given NullableRoleAccessGroupCondition and assigns it to the Group field.
func (o *AccessConditionalExpression) SetGroup(v RoleAccessGroupCondition) {
	o.Group.Set(&v)
}
// SetGroupNil sets the value for Group to be an explicit nil
func (o *AccessConditionalExpression) SetGroupNil() {
	o.Group.Set(nil)
}
...
func (o *AccessConditionalExpression) SetResourceTypeNil() {
...
func (o *AccessConditionalExpression) SetDataClassesNil() {
...
func (o *AccessConditionalExpression) SetEnvironmentNil() {
...
func (o *AccessConditionalExpression) SetAppsNil() {
	o.Apps.Set(nil)
}
...
func (o *AccessConditionalExpression) SetCloudProviderNil() {
...
func (o *AccessConditionalExpression) SetAccountIdNil() {
	o.AccountId.Set(nil)
}
...
func (o *AccessConditionalExpression) SetSourceRegionNil() {
...
func (o *AccessConditionalExpression) SetVpcNil() {
	o.Vpc.Set(nil)
}
...
func (o *AccessConditionalExpression) SetSubnetsNil() {
	o.Subnets.Set(nil)
}
...
func (o *AccessConditionalExpression) SetResourceGroupNameNil() {
...
func (o *AccessConditionalExpression) SetResourceNameNil() {
...
func (o *AccessConditionalExpression) SetResourceIdNil() {
...
func (o *AccessConditionalExpression) SetTagKeysNil() {
	o.TagKeys.Set(nil)
}
...
func (o *AccessConditionalExpression) SetTagKeyValuesNil() {
...
func (o AccessConditionalExpression) MarshalJSON() ([]byte, error) {
...
func (o AccessConditionalExpression) ToMap() (map[string]interface{}, error) {
...
type NullableAccessConditionalExpression struct {
	value *AccessConditionalExpression
	isSet bool
}

func (v NullableAccessConditionalExpression) Get() *AccessConditionalExpression {
	return v.value
}

func (v *NullableAccessConditionalExpression) Set(val *AccessConditionalExpression) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessConditionalExpression) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessConditionalExpression) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessConditionalExpression(val *AccessConditionalExpression) *NullableAccessConditionalExpression {
	return &NullableAccessConditionalExpression{value: val, isSet: true}
}

func (v NullableAccessConditionalExpression) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessConditionalExpression) UnmarshalJSON(src []byte) error {
	v.isSet = true
