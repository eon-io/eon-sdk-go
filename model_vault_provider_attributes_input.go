...
type _VaultProviderAttributesInput VaultProviderAttributesInput
...
func NewVaultProviderAttributesInput(cloudProvider Provider) *VaultProviderAttributesInput {
	this := VaultProviderAttributesInput{}
...
// SetAws gets a reference to the given NullableAwsVaultConfigInput and assigns it to the Aws field.
func (o *VaultProviderAttributesInput) SetAws(v AwsVaultConfigInput) {
	o.Aws.Set(&v)
}
// SetAwsNil sets the value for Aws to be an explicit nil
func (o *VaultProviderAttributesInput) SetAwsNil() {
	o.Aws.Set(nil)
}
...
func (o VaultProviderAttributesInput) MarshalJSON() ([]byte, error) {
...
func (o VaultProviderAttributesInput) ToMap() (map[string]interface{}, error) {
...
func (o *VaultProviderAttributesInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVaultProviderAttributesInput := _VaultProviderAttributesInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	//decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVaultProviderAttributesInput)

	if err != nil {
		return err
	}

	*o = VaultProviderAttributesInput(varVaultProviderAttributesInput)

	return err
}

type NullableVaultProviderAttributesInput struct {
	value *VaultProviderAttributesInput
	isSet bool
}

func (v NullableVaultProviderAttributesInput) Get() *VaultProviderAttributesInput {
	return v.value
}

func (v *NullableVaultProviderAttributesInput) Set(val *VaultProviderAttributesInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVaultProviderAttributesInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVaultProviderAttributesInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVaultProviderAttributesInput(val *VaultProviderAttributesInput) *NullableVaultProviderAttributesInput {
	return &NullableVaultProviderAttributesInput{value: val, isSet: true}
}

func (v NullableVaultProviderAttributesInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVaultProviderAttributesInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
