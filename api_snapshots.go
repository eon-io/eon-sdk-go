...
func (r ApiHoldSnapshotRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.HoldSnapshotExecute(r)
}

/*
HoldSnapshot Hold Snapshot

Description: Places a user hold on an Eon snapshot.
...
func (a *SnapshotsAPIService) HoldSnapshotExecute(r ApiHoldSnapshotRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SnapshotsAPIService.HoldSnapshot")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiRemoveSnapshotHoldRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.RemoveSnapshotHoldExecute(r)
}

/*
RemoveSnapshotHold Remove Snapshot Hold

Description: Removes user hold from an Eon snapshot, allowing it to be removed once it passes its expiration time.
...
// Execute executes the request
//  @return map[string]interface{}
func (a *SnapshotsAPIService) RemoveSnapshotHoldExecute(r ApiRemoveSnapshotHoldRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SnapshotsAPIService.RemoveSnapshotHold")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiRestoreBigQueryDatasetRequest struct {
	ctx context.Context
	ApiService *SnapshotsAPIService
	projectId string
	id string
...
func (r ApiRestoreBigQueryDatasetRequest) RestoreBigQueryDatasetRequest(restoreBigQueryDatasetRequest RestoreBigQueryDatasetRequest) ApiRestoreBigQueryDatasetRequest {
	r.restoreBigQueryDatasetRequest = &restoreBigQueryDatasetRequest
	return r
}
...
/*
RestoreBigQueryDataset Restore BigQuery Dataset

Description: Restores a BigQuery dataset from an Eon snapshot.
...
func (a *SnapshotsAPIService) RestoreBigQueryDatasetExecute(r ApiRestoreBigQueryDatasetRequest) (*RestoreJobInitiationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/resources/{id}/snapshots/{snapshotId}/restore-bigquery-dataset"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"snapshotId"+"}", url.PathEscape(parameterValueToString(r.snapshotId, "snapshotId")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.restoreBigQueryDatasetRequest == nil {
		return localVarReturnValue, nil, reportError("restoreBigQueryDatasetRequest is required and must be specified")
	}
