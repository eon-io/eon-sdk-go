...
// checks if the IdFilters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdFilters{}

// IdFilters struct for IdFilters
type IdFilters struct {
	// Matches if any string in this list equals `id`.
	In []string `json:"in,omitempty"`
	// Matches if no string in this list equals `id`.
...
func (o IdFilters) MarshalJSON() ([]byte, error) {
...
func (o IdFilters) ToMap() (map[string]interface{}, error) {
...
func (v NullableIdFilters) Get() *IdFilters {
	return v.value
}

func (v *NullableIdFilters) Set(val *IdFilters) {
	v.value = val
	v.isSet = true
}

func (v NullableIdFilters) IsSet() bool {
	return v.isSet
}

func (v *NullableIdFilters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdFilters(val *IdFilters) *NullableIdFilters {
	return &NullableIdFilters{value: val, isSet: true}
}

func (v NullableIdFilters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdFilters) UnmarshalJSON(src []byte) error {
	v.isSet = true
