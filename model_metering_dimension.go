...
const (
	...
	AWS_EC2_NATIVE_METERING_DIMENSION MeteringDimension = "AWS_EC2_NATIVE_METERING_DIMENSION"
	AWS_RDS_METERING_DIMENSION MeteringDimension = "AWS_RDS_METERING_DIMENSION"
	AWS_RDS_ORACLE_METERING_DIMENSION MeteringDimension = "AWS_RDS_ORACLE_METERING_DIMENSION"
	AWS_EC2_CASSANDRA_METERING_DIMENSION MeteringDimension = "AWS_EC2_CASSANDRA_METERING_DIMENSION"
	AWS_S3_METERING_DIMENSION MeteringDimension = "AWS_S3_METERING_DIMENSION"
	AWS_S3_DLSG_METERING_DIMENSION MeteringDimension = "AWS_S3_DLSG_METERING_DIMENSION"
	...
	AZURE_VM_CASSANDRA_METERING_DIMENSION MeteringDimension = "AZURE_VM_CASSANDRA_METERING_DIMENSION"
	...
	AZURE_SQL_DATABASE_METERING_DIMENSION MeteringDimension = "AZURE_SQL_DATABASE_METERING_DIMENSION"
	AZURE_POSTGRESQL_METERING_DIMENSION MeteringDimension = "AZURE_POSTGRESQL_METERING_DIMENSION"
	GCP_VM_INSTANCE_METERING_DIMENSION MeteringDimension = "GCP_VM_INSTANCE_METERING_DIMENSION"
	GCP_VM_NATIVE_METERING_DIMENSION MeteringDimension = "GCP_VM_NATIVE_METERING_DIMENSION"
	GCP_VM_CASSANDRA_METERING_DIMENSION MeteringDimension = "GCP_VM_CASSANDRA_METERING_DIMENSION"
	...
	GCP_BIG_QUERY_METERING_DIMENSION MeteringDimension = "GCP_BIG_QUERY_METERING_DIMENSION"
	MONGO_ATLAS_CLUSTER_METERING_DIMENSION MeteringDimension = "MONGO_ATLAS_CLUSTER_METERING_DIMENSION"
	DATA_TRANSFER_METERING_DIMENSION MeteringDimension = "DATA_TRANSFER_METERING_DIMENSION"
	CLASSIFICATION_METERING_DIMENSION MeteringDimension = "CLASSIFICATION_METERING_DIMENSION"
	...
	AZURE_SQL_DATABASE_TO_AWS_VAULT_METERING_DIMENSION MeteringDimension = "AZURE_SQL_DATABASE_TO_AWS_VAULT_METERING_DIMENSION"
	AZURE_POSTGRESQL_TO_AWS_VAULT_METERING_DIMENSION MeteringDimension = "AZURE_POSTGRESQL_TO_AWS_VAULT_METERING_DIMENSION"
	GCP_VM_INSTANCE_TO_AZURE_VAULT_METERING_DIMENSION MeteringDimension = "GCP_VM_INSTANCE_TO_AZURE_VAULT_METERING_DIMENSION"
	GCP_CLOUD_STORAGE_TO_AZURE_VAULT_METERING_DIMENSION MeteringDimension = "GCP_CLOUD_STORAGE_TO_AZURE_VAULT_METERING_DIMENSION"
	GCP_CLOUD_SQL_POSTGRES_TO_AZURE_VAULT_METERING_DIMENSION MeteringDimension = "GCP_CLOUD_SQL_POSTGRES_TO_AZURE_VAULT_METERING_DIMENSION"
	GCP_CLOUD_SQL_MYSQL_TO_AZURE_VAULT_METERING_DIMENSION MeteringDimension = "GCP_CLOUD_SQL_MYSQL_TO_AZURE_VAULT_METERING_DIMENSION"
	GCP_CLOUD_SQL_SQL_SERVER_TO_AZURE_VAULT_METERING_DIMENSION MeteringDimension = "GCP_CLOUD_SQL_SQL_SERVER_TO_AZURE_VAULT_METERING_DIMENSION"
	AWS_EC2_TO_GCP_VAULT_METERING_DIMENSION MeteringDimension = "AWS_EC2_TO_GCP_VAULT_METERING_DIMENSION"
	AWS_S3_TO_GCP_VAULT_METERING_DIMENSION MeteringDimension = "AWS_S3_TO_GCP_VAULT_METERING_DIMENSION"
	AWS_RDS_TO_GCP_VAULT_METERING_DIMENSION MeteringDimension = "AWS_RDS_TO_GCP_VAULT_METERING_DIMENSION"
	AWS_DYNAMO_DB_TO_GCP_VAULT_METERING_DIMENSION MeteringDimension = "AWS_DYNAMO_DB_TO_GCP_VAULT_METERING_DIMENSION"
	AWS_EKS_TO_GCP_VAULT_METERING_DIMENSION MeteringDimension = "AWS_EKS_TO_GCP_VAULT_METERING_DIMENSION"
	AZURE_VIRTUAL_MACHINE_TO_GCP_VAULT_METERING_DIMENSION MeteringDimension = "AZURE_VIRTUAL_MACHINE_TO_GCP_VAULT_METERING_DIMENSION"
	AZURE_STORAGE_ACCOUNT_TO_GCP_VAULT_METERING_DIMENSION MeteringDimension = "AZURE_STORAGE_ACCOUNT_TO_GCP_VAULT_METERING_DIMENSION"
	AZURE_SQL_VIRTUAL_MACHINE_TO_GCP_VAULT_METERING_DIMENSION MeteringDimension = "AZURE_SQL_VIRTUAL_MACHINE_TO_GCP_VAULT_METERING_DIMENSION"
	AZURE_SQL_DATABASE_TO_GCP_VAULT_METERING_DIMENSION MeteringDimension = "AZURE_SQL_DATABASE_TO_GCP_VAULT_METERING_DIMENSION"
	AZURE_POSTGRESQL_TO_GCP_VAULT_METERING_DIMENSION MeteringDimension = "AZURE_POSTGRESQL_TO_GCP_VAULT_METERING_DIMENSION"
	GCP_VM_INSTANCE_TO_AWS_VAULT_METERING_DIMENSION MeteringDimension = "GCP_VM_INSTANCE_TO_AWS_VAULT_METERING_DIMENSION"
	GCP_CLOUD_STORAGE_TO_AWS_VAULT_METERING_DIMENSION MeteringDimension = "GCP_CLOUD_STORAGE_TO_AWS_VAULT_METERING_DIMENSION"
	GCP_CLOUD_SQL_POSTGRES_TO_AWS_VAULT_METERING_DIMENSION MeteringDimension = "GCP_CLOUD_SQL_POSTGRES_TO_AWS_VAULT_METERING_DIMENSION"
	GCP_CLOUD_SQL_MYSQL_TO_AWS_VAULT_METERING_DIMENSION MeteringDimension = "GCP_CLOUD_SQL_MYSQL_TO_AWS_VAULT_METERING_DIMENSION"
	GCP_CLOUD_SQL_SQL_SERVER_TO_AWS_VAULT_METERING_DIMENSION MeteringDimension = "GCP_CLOUD_SQL_SQL_SERVER_TO_AWS_VAULT_METERING_DIMENSION"
	GCP_CLOUD_SQL_TO_AWS_VAULT_METERING_DIMENSION MeteringDimension = "GCP_CLOUD_SQL_TO_AWS_VAULT_METERING_DIMENSION"
	STORAGE_GATEWAY_METERING_DIMENSION MeteringDimension = "STORAGE_GATEWAY_METERING_DIMENSION"
	RANSOMWARE_PROTECTED_STORAGE_METERING_DIMENSION MeteringDimension = "RANSOMWARE_PROTECTED_STORAGE_METERING_DIMENSION"
	SAAS_BACKUP_STORAGE_METERING_DIMENSION MeteringDimension = "SAAS_BACKUP_STORAGE_METERING_DIMENSION"
	SAAS_BACKUP_SEATS_METERING_DIMENSION MeteringDimension = "SAAS_BACKUP_SEATS_METERING_DIMENSION"
	SAAS_BACKUP_SEATS_RANSOMWARE_METERING_DIMENSION MeteringDimension = "SAAS_BACKUP_SEATS_RANSOMWARE_METERING_DIMENSION"
)
...
var AllowedMeteringDimensionEnumValues = []MeteringDimension{
	...
	"AWS_EC2_CASSANDRA_METERING_DIMENSION",
	...
	"AZURE_VM_CASSANDRA_METERING_DIMENSION",
	...
	"AZURE_POSTGRESQL_METERING_DIMENSION",
	"GCP_VM_INSTANCE_METERING_DIMENSION",
	"GCP_VM_NATIVE_METERING_DIMENSION",
	"GCP_VM_CASSANDRA_METERING_DIMENSION",
	...
	"CLASSIFICATION_METERING_DIMENSION",
	...
	"AZURE_SQL_DATABASE_TO_AWS_VAULT_METERING_DIMENSION",
	"AZURE_POSTGRESQL_TO_AWS_VAULT_METERING_DIMENSION",
	...
	"AZURE_SQL_DATABASE_TO_GCP_VAULT_METERING_DIMENSION",
	"AZURE_POSTGRESQL_TO_GCP_VAULT_METERING_DIMENSION",
	...
	"GCP_CLOUD_SQL_TO_AWS_VAULT_METERING_DIMENSION",
	"STORAGE_GATEWAY_METERING_DIMENSION",
	"RANSOMWARE_PROTECTED_STORAGE_METERING_DIMENSION",
	"SAAS_BACKUP_STORAGE_METERING_DIMENSION",
	"SAAS_BACKUP_SEATS_METERING_DIMENSION",
	"SAAS_BACKUP_SEATS_RANSOMWARE_METERING_DIMENSION",
}
