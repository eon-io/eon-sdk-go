...
func Test_eon_ResourcesAPIService(t *testing.T) {
	...
	t.Run("Test ResourcesAPIService CancelVolumeBackupExclusion", func(t *testing.T) {
	...
	t.Run("Test ResourcesAPIService ExcludeVolumeFromBackup", func(t *testing.T) {
	...
	t.Run("Test ResourcesAPIService GetResource", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ResourcesAPI.GetResource(context.Background(), projectId, id).Execute()
