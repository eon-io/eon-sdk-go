...
You can check a query's status by calling [Get Query Status](./get-query-status).
 ...
 @param projectId ID of the project that contains the query you want to retrieve. You can see your project ID in the [API Credentials](https://console.eon.io/global-management/api-credentials) page in your global management console.  
...
[Troubleshooting Queries]: /user-guide/searching-exploring-and-querying/query/troubleshooting-queries
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId ID of the project that contains the query status you want to retrieve. You can see your project ID in the [API Credentials](https://console.eon.io/global-management/api-credentials) page in your global management console.  
 @param queryId Query ID returned by [Run Query](./run-query).
...
[Get Query Result]: ./get-query-result
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId ID of the project that contains the database snapshot you want to retrieve. You can see your project ID in the [API Credentials](https://console.eon.io/global-management/api-credentials) page in your global management console.  
 @param snapshotId ID of the database [snapshot](/api/api-reference/backup-management/snapshots/list-resource-snapshots) you want to query. Snapshot must belong to an RDS resource. 
