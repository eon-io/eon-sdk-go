...
type ApiGetObjectStoreScanMethodRequest struct {
	ctx context.Context
	ApiService *ResourcesAPIService
	projectId string
	id string
...
func (r ApiGetObjectStoreScanMethodRequest) Execute() (*GetObjectStoreScanMethodResponse, *http.Response, error) {
	return r.ApiService.GetObjectStoreScanMethodExecute(r)
}

/*
GetObjectStoreScanMethod Get object-store scan method

Description: Retrieves object-store scan method settings for an AWS S3 bucket or GCP Cloud Storage bucket.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId ID of the project the resource is in. You can get your project ID from the [API Credentials](https://console.eon.io/global-management/api-credentials) page in your global management console. 
 @param id Eon-assigned ID of the AWS S3 bucket or GCP Cloud Storage bucket resource.
 @return ApiGetObjectStoreScanMethodRequest
*/
func (a *ResourcesAPIService) GetObjectStoreScanMethod(ctx context.Context, projectId string, id string) ApiGetObjectStoreScanMethodRequest {
	return ApiGetObjectStoreScanMethodRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return GetObjectStoreScanMethodResponse
func (a *ResourcesAPIService) GetObjectStoreScanMethodExecute(r ApiGetObjectStoreScanMethodRequest) (*GetObjectStoreScanMethodResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetObjectStoreScanMethodResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResourcesAPIService.GetObjectStoreScanMethod")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/projects/{projectId}/resources/{id}/object-store-scan-method"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
Description: Retrieves a list of resources for the given project.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId ID of the project whose resources you want to retrieve. You can get your project ID from the [API Credentials](https://console.eon.io/global-management/api-credentials) page in your global management console. 
...
type ApiUpdateObjectStoreScanMethodRequest struct {
	ctx context.Context
	ApiService *ResourcesAPIService
	projectId string
	id string
...
func (r ApiUpdateObjectStoreScanMethodRequest) Execute() (*UpdateObjectStoreScanMethodResponse, *http.Response, error) {
	return r.ApiService.UpdateObjectStoreScanMethodExecute(r)
}

/*
UpdateObjectStoreScanMethod Update object-store scan method

Description: Updates object-store scan method settings for an AWS S3 bucket or GCP Cloud Storage bucket. Despite S3-oriented setting names, CDC and inventory settings apply to both AWS S3 buckets and GCP Cloud Storage buckets.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId ID of the project the resource is in. You can get your project ID from the [API Credentials](https://console.eon.io/global-management/api-credentials) page in your global management console. 
 @param id Eon-assigned ID of the AWS S3 bucket or GCP Cloud Storage bucket resource.
 @return ApiUpdateObjectStoreScanMethodRequest
*/
func (a *ResourcesAPIService) UpdateObjectStoreScanMethod(ctx context.Context, projectId string, id string) ApiUpdateObjectStoreScanMethodRequest {
	return ApiUpdateObjectStoreScanMethodRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return UpdateObjectStoreScanMethodResponse
func (a *ResourcesAPIService) UpdateObjectStoreScanMethodExecute(r ApiUpdateObjectStoreScanMethodRequest) (*UpdateObjectStoreScanMethodResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateObjectStoreScanMethodResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResourcesAPIService.UpdateObjectStoreScanMethod")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateObjectStoreScanMethodRequest == nil {
		return localVarReturnValue, nil, reportError("updateObjectStoreScanMethodRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateObjectStoreScanMethodRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
