...
type ApiDeleteSourceAccountRequest struct {
	ctx context.Context
	ApiService *AccountsAPIService
	projectId string
	accountId string
...
func (r ApiDeleteSourceAccountRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteSourceAccountExecute(r)
}

/*
DeleteSourceAccount Delete Source Account
...
Source accounts with `CONNECTED` status must be disconnected before they can be deleted.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId ID of the project. You can get your project ID from the [API Credentials](https://console.eon.io/global-management/api-credentials) page in your global management console. 
 @param accountId Eon-assigned ID of the source account to delete.
 @return ApiDeleteSourceAccountRequest
*/
func (a *AccountsAPIService) DeleteSourceAccount(ctx context.Context, projectId string, accountId string) ApiDeleteSourceAccountRequest {
	return ApiDeleteSourceAccountRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
func (a *AccountsAPIService) DeleteSourceAccountExecute(r ApiDeleteSourceAccountRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountsAPIService.DeleteSourceAccount")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetRestoreAccountRequest struct {
	ctx context.Context
	ApiService *AccountsAPIService
	projectId string
	accountId string
...
func (r ApiGetRestoreAccountRequest) Execute() (*GetRestoreAccountResponse, *http.Response, error) {
	return r.ApiService.GetRestoreAccountExecute(r)
}

/*
GetRestoreAccount Get Restore Account

Description: Retrieve a restore account by ID.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId ID of the project.
 @param accountId Eon-assigned ID of the restore account.
 @return ApiGetRestoreAccountRequest
*/
func (a *AccountsAPIService) GetRestoreAccount(ctx context.Context, projectId string, accountId string) ApiGetRestoreAccountRequest {
	return ApiGetRestoreAccountRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return GetRestoreAccountResponse
func (a *AccountsAPIService) GetRestoreAccountExecute(r ApiGetRestoreAccountRequest) (*GetRestoreAccountResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetRestoreAccountResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountsAPIService.GetRestoreAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateRestoreAccountRequest struct {
	ctx context.Context
	ApiService *AccountsAPIService
	projectId string
	accountId string
	updateRestoreAccountRequest *UpdateRestoreAccountRequest
}

func (r ApiUpdateRestoreAccountRequest) UpdateRestoreAccountRequest(updateRestoreAccountRequest UpdateRestoreAccountRequest) ApiUpdateRestoreAccountRequest {
	r.updateRestoreAccountRequest = &updateRestoreAccountRequest
	return r
}

func (r ApiUpdateRestoreAccountRequest) Execute() (*UpdateRestoreAccountResponse, *http.Response, error) {
	return r.ApiService.UpdateRestoreAccountExecute(r)
}
...
Description: Updates restore account properties.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId ID of the project.
 @param accountId Eon-assigned ID of the restore account to update.
 @return ApiUpdateRestoreAccountRequest
*/
func (a *AccountsAPIService) UpdateRestoreAccount(ctx context.Context, projectId string, accountId string) ApiUpdateRestoreAccountRequest {
	return ApiUpdateRestoreAccountRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return UpdateRestoreAccountResponse
func (a *AccountsAPIService) UpdateRestoreAccountExecute(r ApiUpdateRestoreAccountRequest) (*UpdateRestoreAccountResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateRestoreAccountResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountsAPIService.UpdateRestoreAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateRestoreAccountRequest == nil {
		return localVarReturnValue, nil, reportError("updateRestoreAccountRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateRestoreAccountRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
