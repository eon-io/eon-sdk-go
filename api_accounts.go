...
type ApiGetAzureOnboardedTenantsRequest struct {
	ctx context.Context
	ApiService *AccountsAPIService
	projectId string
}

func (r ApiGetAzureOnboardedTenantsRequest) Execute() (*AzureOnboardedTenantsResponse, *http.Response, error) {
	return r.ApiService.GetAzureOnboardedTenantsExecute(r)
}

/*
GetAzureOnboardedTenants Get onboarded Azure tenants for an Eon account

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId The project ID
 @return ApiGetAzureOnboardedTenantsRequest
*/
func (a *AccountsAPIService) GetAzureOnboardedTenants(ctx context.Context, projectId string) ApiGetAzureOnboardedTenantsRequest {
	return ApiGetAzureOnboardedTenantsRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return AzureOnboardedTenantsResponse
func (a *AccountsAPIService) GetAzureOnboardedTenantsExecute(r ApiGetAzureOnboardedTenantsRequest) (*AzureOnboardedTenantsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AzureOnboardedTenantsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountsAPIService.GetAzureOnboardedTenants")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/projects/{projectId}/azure/onboarded-tenants"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
