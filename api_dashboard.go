...
Description: Retrieves a list of snapshot storage sizes per day for the given date range.
 ...
 @param projectId ID of the project whose daily storage summaries you want to retrieve. You can get your project ID from the [API Credentials](https://console.eon.io/global-management/api-credentials) page in your global management console. 
