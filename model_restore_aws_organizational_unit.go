...
// checks if the RestoreAwsOrganizationalUnit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestoreAwsOrganizationalUnit{}

// RestoreAwsOrganizationalUnit struct for RestoreAwsOrganizationalUnit
...
type _RestoreAwsOrganizationalUnit RestoreAwsOrganizationalUnit
...
func NewRestoreAwsOrganizationalUnit(id string, roleArn string, name string, providerOrganizationalUnitId string, providerManagementAccountId string, status AccountState) *RestoreAwsOrganizationalUnit {
	this := RestoreAwsOrganizationalUnit{}
	this.Id = id
...
func (o RestoreAwsOrganizationalUnit) MarshalJSON() ([]byte, error) {
...
func (o RestoreAwsOrganizationalUnit) ToMap() (map[string]interface{}, error) {
...
func (o *RestoreAwsOrganizationalUnit) UnmarshalJSON(data []byte) (err error) {
	...
	varRestoreAwsOrganizationalUnit := _RestoreAwsOrganizationalUnit{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	//decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestoreAwsOrganizationalUnit)

	if err != nil {
		return err
	}

	*o = RestoreAwsOrganizationalUnit(varRestoreAwsOrganizationalUnit)

	return err
}

type NullableRestoreAwsOrganizationalUnit struct {
	value *RestoreAwsOrganizationalUnit
	isSet bool
}

func (v NullableRestoreAwsOrganizationalUnit) Get() *RestoreAwsOrganizationalUnit {
	return v.value
}

func (v *NullableRestoreAwsOrganizationalUnit) Set(val *RestoreAwsOrganizationalUnit) {
	v.value = val
	v.isSet = true
}

func (v NullableRestoreAwsOrganizationalUnit) IsSet() bool {
	return v.isSet
}

func (v *NullableRestoreAwsOrganizationalUnit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestoreAwsOrganizationalUnit(val *RestoreAwsOrganizationalUnit) *NullableRestoreAwsOrganizationalUnit {
	return &NullableRestoreAwsOrganizationalUnit{value: val, isSet: true}
}

func (v NullableRestoreAwsOrganizationalUnit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestoreAwsOrganizationalUnit) UnmarshalJSON(src []byte) error {
	v.isSet = true
