...
* `COST_GROUP_BY_PRODUCT` (value: `"PRODUCT"`)

* `COST_GROUP_BY_USAGE_TYPE` (value: `"USAGE_TYPE"`)

* `COST_GROUP_BY_DSG_BUCKET` (value: `"DSG_BUCKET"`)

* `COST_GROUP_BY_DSG_ENVIRONMENT` (value: `"DSG_ENVIRONMENT"`)
