...
* `AWS_DOCUMENTDB_BACKUP` (value: `"AWS_DOCUMENTDB_BACKUP"`)

* `AWS_NEPTUNE_BACKUP` (value: `"AWS_NEPTUNE_BACKUP"`)

* `AWS_DYNAMO_DB_BACKUP` (value: `"AWS_DYNAMO_DB_BACKUP"`)

* `AWS_DYNAMO_DB_BACKUP_FULL` (value: `"AWS_DYNAMO_DB_BACKUP_FULL"`)

* `AWS_DYNAMO_DB_BACKUP_FULL_EXPORT` (value: `"AWS_DYNAMO_DB_BACKUP_FULL_EXPORT"`)

* `AWS_EKS_NAMESPACE_BACKUP` (value: `"AWS_EKS_NAMESPACE_BACKUP"`)

* `AWS_EKS_CLUSTER_BACKUP` (value: `"AWS_EKS_CLUSTER_BACKUP"`)

* `AWS_KEYSPACES_BACKUP_FULL` (value: `"AWS_KEYSPACES_BACKUP_FULL"`)

* `AWS_CASSANDRA_CLUSTER_BACKUP` (value: `"AWS_CASSANDRA_CLUSTER_BACKUP"`)

* `AWS_OPENSEARCH_BACKUP` (value: `"AWS_OPENSEARCH_BACKUP"`)
...
* `GCP_SAP_HANA_VM_BACKUP` (value: `"GCP_SAP_HANA_VM_BACKUP"`)
