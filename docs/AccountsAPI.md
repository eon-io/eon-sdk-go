...
func main() {
	...
	connectRestoreAccountRequest := *openapiclient.NewConnectRestoreAccountRequest(*openapiclient.NewRestoreAccountConfigInput(openapiclient.Provider("AWS"))) // ConnectRestoreAccountRequest | 
...
func main() {
	...
	connectSourceAccountRequest := *openapiclient.NewConnectSourceAccountRequest(*openapiclient.NewSourceAccountConfigInput(openapiclient.Provider("AWS"))) // ConnectSourceAccountRequest | 
