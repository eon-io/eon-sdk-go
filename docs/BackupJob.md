...
**Steps** | Pointer to [**[]JobStep**](JobStep.md) | Job steps. Only populated for job types that have steps defined. | [optional] 
...
`func (o *BackupJob) SetStepsNil(b bool)`

 SetStepsNil sets the value for Steps to be an explicit nil

### UnsetSteps
`func (o *BackupJob) UnsetSteps()`
