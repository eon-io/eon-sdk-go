...
GetPreserveInstanceNames returns the PreserveInstanceNames field if non-nil, zero value otherwise.

### GetPreserveInstanceNamesOk

`func (o *AwsDatabaseDestination) GetPreserveInstanceNamesOk() (*bool, bool)`

GetPreserveInstanceNamesOk returns a tuple with the PreserveInstanceNames field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetPreserveInstanceNames

`func (o *AwsDatabaseDestination) SetPreserveInstanceNames(v bool)`

SetPreserveInstanceNames sets PreserveInstanceNames field to given value.

### HasPreserveInstanceNames
