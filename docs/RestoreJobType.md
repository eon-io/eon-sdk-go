...
* `AWS_EBS_VOLUME_RESTORE` (value: `"AWS_EBS_VOLUME_RESTORE"`)

* `AWS_EBS_SNAPSHOT_CONVERT` (value: `"AWS_EBS_SNAPSHOT_CONVERT"`)
...
* `AWS_DYNAMO_DB_TABLE_TO_EXISTING_TABLE_RESTORE` (value: `"AWS_DYNAMO_DB_TABLE_TO_EXISTING_TABLE_RESTORE"`)

* `AWS_DYNAMO_DB_RESTORE_TO_S3` (value: `"AWS_DYNAMO_DB_RESTORE_TO_S3"`)
...
* `AZURE_VM_NATIVE_DISK_RESTORE` (value: `"AZURE_VM_NATIVE_DISK_RESTORE"`)

* `AZURE_VM_NATIVE_VM_RESTORE` (value: `"AZURE_VM_NATIVE_VM_RESTORE"`)
...
* `AZURE_POSTGRESQL_RECORD_RESTORE` (value: `"AZURE_POSTGRESQL_RECORD_RESTORE"`)

* `AZURE_SAP_HANA_VM_INSTANCE_RESTORE` (value: `"AZURE_SAP_HANA_VM_INSTANCE_RESTORE"`)
...
* `GCP_BIGQUERY_NATIVE_RESTORE_DATASET` (value: `"GCP_BIGQUERY_NATIVE_RESTORE_DATASET"`)

* `GCP_BIGQUERY_NATIVE_RESTORE_TABLE` (value: `"GCP_BIGQUERY_NATIVE_RESTORE_TABLE"`)

* `RDS_NATIVE_PITR_RESTORE` (value: `"RDS_NATIVE_PITR_RESTORE"`)

* `AWS_FSX_RESTORE` (value: `"AWS_FSX_RESTORE"`)

* `AWS_DOCUMENTDB_RESTORE` (value: `"AWS_DOCUMENTDB_RESTORE"`)

* `AWS_NEPTUNE_RESTORE` (value: `"AWS_NEPTUNE_RESTORE"`)

* `GCP_SAP_HANA_VM_INSTANCE_RESTORE` (value: `"GCP_SAP_HANA_VM_INSTANCE_RESTORE"`)

* `AWS_KEYSPACES_TABLE_RESTORE` (value: `"AWS_KEYSPACES_TABLE_RESTORE"`)

* `AWS_KEYSPACES_RECORD_RESTORE` (value: `"AWS_KEYSPACES_RECORD_RESTORE"`)

* `AWS_CASSANDRA_CLUSTER_RESTORE` (value: `"AWS_CASSANDRA_CLUSTER_RESTORE"`)

* `AWS_OPENSEARCH_DOMAIN_RESTORE` (value: `"AWS_OPENSEARCH_DOMAIN_RESTORE"`)

* `ATLAS_CLUSTER_RESTORE` (value: `"ATLAS_CLUSTER_RESTORE"`)

* `ATLAS_CLUSTER_RECORD_RESTORE` (value: `"ATLAS_CLUSTER_RECORD_RESTORE"`)

* `MICROSOFT_365_RESTORE` (value: `"MICROSOFT_365_RESTORE"`)

* `GOOGLE_WORKSPACE_RESTORE` (value: `"GOOGLE_WORKSPACE_RESTORE"`)

* `AZURE_ENTRA_ID_RESTORE` (value: `"AZURE_ENTRA_ID_RESTORE"`)

* `AZURE_ENTRA_ID_MICROSOFT_365_RESTORE` (value: `"AZURE_ENTRA_ID_MICROSOFT_365_RESTORE"`)
