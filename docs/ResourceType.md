...
* `AWS_EBS_VOLUME` (value: `"AWS_EBS_VOLUME"`)

* `AWS_KEYSPACES_TABLE` (value: `"AWS_KEYSPACES_TABLE"`)

* `AWS_CASSANDRA_CLUSTER` (value: `"AWS_CASSANDRA_CLUSTER"`)

* `GCP_CASSANDRA_CLUSTER` (value: `"GCP_CASSANDRA_CLUSTER"`)

* `AZURE_CASSANDRA_CLUSTER` (value: `"AZURE_CASSANDRA_CLUSTER"`)
...
* `AZURE_SAP_HANA_VM` (value: `"AZURE_SAP_HANA_VM"`)
...
* `GOOGLE_WORKSPACE_RESOURCE` (value: `"GOOGLE_WORKSPACE_RESOURCE"`)

* `MICROSOFT_365_RESOURCE` (value: `"MICROSOFT_365_RESOURCE"`)
